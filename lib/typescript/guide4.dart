...
You
Sent by you:
Convert to dart:import { types } from "binary-data";
...
You
Sent by you:
Convert to dart: export enum HandshakeType {
  hello_request_0 = 0,
  client_hello_1 = 1,
  server_hello_2 = 2,
...
Copilot
Sent by Copilot:
Here’s the Dart equivalent of your TypeScript enum:
...
AI-generated code. Review and use carefully. More info on FAQ.
This Dart code mirrors the structure and functionality of your TypeScript enum. If you have any questions or need further adjustments, feel free to ask!

You
Sent by you:
Convert to dart: /* eslint-disable @typescript-eslint/ban-ts-comment */
import { decode, encode, types } from "binary-data";
...
You
Sent by you:
Convert to dart: import { decode, encode, types } from "binary-data";
