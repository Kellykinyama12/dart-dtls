import 'package:dtls2/typescript/cipher/key_exchange.dart';
...
const AEAD_AES_128_GCM = (
  ...
  P_MAX: 2 *2* 36 - 31, // Max length of a plaintext.
 ...
 * @param {number} cipher
 */
Function createCipher(int cipher) {
  switch (cipher) {
...
Function createAEADCipher(
  ...
  String block,//: string,
  KeyExchange kx,
  ({int K_LEN, int N_MAX })constants,//: { K_LEN: number; N_MAX: number },
 String hash = "sha256"
) {
